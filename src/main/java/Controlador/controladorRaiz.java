	...
	public controladorRaiz(Ventana ventana, modelo modelo) {
		...
		ventana.raiz.btnSumKids.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				else if(num_huespedes ==9 || num_huespedes ==10 && num_kids >=2) 
				{ //cuando haya 9 /10 adultos maximo niños 2
					ventana.raiz.btnSumKids.setEnabled(false);
					
				} 
				else if(num_huespedes == 8 || num_huespedes == 7 && num_kids >=4) 
				{ // cuando haya 8 adultos maximo niños 4
					ventana.raiz.btnSumKids.setEnabled(false);
				
				}
				else if(num_huespedes ==6 || num_huespedes ==5 || num_huespedes ==4 && num_kids >=6) 
				{ //cuando haya 6 adultos maximo niños 6
					ventana.raiz.btnSumKids.setEnabled(false);
		...
		ventana.raiz.btnRestKids.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				{ // cuando haya 9 adultos y menos de 2 niños activar btnSumKids
					ventana.raiz.btnSumKids.setEnabled(true);
				...
				{ //cuando haya 6 adultos y menos de 6 niños activar btnSumKids
					ventana.raiz.btnRestKids.setEnabled(true); 
				
				}
				else if(num_huespedes == 3 || num_huespedes ==2 && num_kids <4) 
				{ //cuando haya 3 adultos y menos de 4 niños activar btnSumKids
					ventana.raiz.btnRestKids.setEnabled(true);
				
				}
				else if(num_huespedes == 1 && num_kids <2) 
				{ //cuando haya 1 adultos y menos de 2 niños activar btnSumKids
					ventana.raiz.btnRestKids.setEnabled(true);
				}
			}
		});
